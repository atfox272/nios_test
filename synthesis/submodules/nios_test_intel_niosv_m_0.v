...
`timescale 1 ps / 1 ps
module nios_test_intel_niosv_m_0 (
	...
	nios_test_intel_niosv_m_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	nios_test_intel_niosv_m_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	nios_test_intel_niosv_m_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
